...
public class KakaoPayService {
    ...
    public kakopayready payReady(int totalAmount, String userid) {
		...
		parameters.add("approval_url", GlobalProperties.awspath + GlobalProperties.servepath + "/pay/kakao/completed.do"); // 결제승인시 넘어갈 url
		parameters.add("cancel_url", GlobalProperties.awspath + GlobalProperties.servepath + "/pay/kakao/paycancel.do"); // 결제취소시 넘어갈 url
		parameters.add("fail_url", GlobalProperties.awspath + GlobalProperties.servepath + "/pay/kakao/payfail.do"); // 결제 실패시 넘어갈 url
