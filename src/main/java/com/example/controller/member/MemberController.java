...
import com.example.service.stmpmail.ResisterMail;
...
public class MemberController {
    ...
    public String mypageGET(
        ...
        if( session.getAttribute("LOGIN").equals("일반회원")  ){
            ...
            if(img != null){
                session.setAttribute("url", GlobalProperties.awspath + GlobalProperties.servepath + "/member/imageselect?userid=" + userid );
